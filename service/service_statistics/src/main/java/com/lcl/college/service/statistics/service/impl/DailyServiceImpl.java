package com.lcl.college.service.statistics.service.impl;
...
import com.lcl.college.service.statistics.mapper.DailyMapper;
...
public class DailyServiceImpl extends ServiceImpl<DailyMapper, Daily> implements DailyService {
    ...
    public void createStatisticsByDay(String day) {
       ...
       /* R r = ucenterMemberService.countRegisterNum(day);
        ...
        int registerNum = RandomUtils.nextInt(20, 100);
