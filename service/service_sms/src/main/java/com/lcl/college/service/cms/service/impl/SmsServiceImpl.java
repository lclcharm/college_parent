package com.lcl.college.service.cms.service.impl;
...
import com.lcl.college.service.cms.util.TxCloudSmsUtil;
import com.lcl.college.service.cms.service.SmsService;
import com.lcl.college.service.cms.util.SmsProperties;
...
public class SmsServiceImpl implements SmsService {
    ...
    public void send(String mobile, String checkCode) throws ClientException{
        String s = txCloudSmsUtil.sendSms(mobile, checkCode);

        if (!"success".equals(s)) {
            log.error("短信发送失败 " + " - code: " + checkCode);
            throw new CollegeException(ResultCodeEnum.SMS_SEND_ERROR);
        }
    }
}
