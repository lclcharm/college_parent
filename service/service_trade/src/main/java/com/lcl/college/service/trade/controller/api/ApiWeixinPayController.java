package com.lcl.college.service.trade.controller.api;

import com.github.wxpay.sdk.WXPayUtil;
import com.lcl.college.common.base.result.R;
import com.lcl.college.common.base.util.StreamUtils;
import com.lcl.college.service.trade.entity.Order;
import com.lcl.college.service.trade.service.OrderService;
import com.lcl.college.service.trade.service.WeixinPayService;
import com.lcl.college.service.trade.util.WeixinPayProperties;
...
//        Map map = weixinPayService.createNative(orderNo, remoteAddr);
        ...
        orderMap.put("total_fee", totalFee); //金额数, 单位是分
        ...
        return R.ok().data("out_trade_no", orderNo).data("total_fee", totalFee).data("course_id", courseId);
