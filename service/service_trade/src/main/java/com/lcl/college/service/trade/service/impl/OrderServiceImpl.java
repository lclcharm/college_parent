package com.lcl.college.service.trade.service.impl;
...
import com.lcl.college.service.trade.entity.PayLog;
...
import com.lcl.college.service.trade.mapper.OrderMapper;
import com.lcl.college.service.trade.mapper.PayLogMapper;
import com.lcl.college.service.trade.service.OrderService;
import com.lcl.college.service.trade.util.OrderNoUtils;
...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, Order> implements OrderService {
    ...
    public String updateOrderStatus(Map<String, String> map) {
        ...
        QueryWrapper<PayLog> objectQueryWrapper = new QueryWrapper<>();
        objectQueryWrapper.eq("order_no", orderNo);
        PayLog payLog1 = payLogMapper.selectOne(objectQueryWrapper);
        if (!(payLog1 == null)) {
