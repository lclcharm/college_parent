package com.lcl.college.service.sys.controller.admin;
...
public class MessageController {
    ...
    public R save(
        ...
        boolean articleResult = messageService.save(article);
        articleContent.setId(article.getId());
        int contentResult = messageService.addArticleContent(articleContent);
    ...
    public R update(
        ...
        int articleResult = messageService.updateArticle(article);
        articleContent.setId(article.getId());
        int contentResult = messageService.updateArticleContent(articleContent);
    ...
    public R deleteBatch(
        ...
        try {
//            messageService.deleteArticleByIds(idList);
    ...
    public R index(@ApiParam(value = "当前页码", required = true)
        ...
        IPage<Article> articleIPage = messageService.pageQueryArticle(pageParam,articleQueryVo);
